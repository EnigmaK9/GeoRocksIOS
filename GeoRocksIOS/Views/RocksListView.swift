...
//  Navigation to FavoritesView has been implemented for easy access to favorited rocks.
//
...
struct RocksListView: View {
    ...
    @EnvironmentObject var authViewModel: AuthViewModel // Accesses the shared AuthViewModel
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Rocks List") // Sets the navigation title
            .toolbar {
                // Toolbar item added for navigating to FavoritesView
